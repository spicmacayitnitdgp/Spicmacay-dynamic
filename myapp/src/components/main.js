    ...
    -->
         ...
         <div className="row" id="about">
            ...
            <h1 style={{textAlign:'center'}}>ABOUT SPICMACAY, NIT Durgapur Chapter</h1>
                ...
                <p style={{fontFamily:"Times new roman !important", fontStyle:'normal !important', wordWrap:'break-word'}}>SPIC MACAY (Society for the Promotion of Indian Classical Music And Culture Amongst Youth) is a non-political, nationwide, voluntary movement founded in 1977 
